	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<form action="${contextRoot}/order/findByCondition" method="get" style="border: 2px dashed black; width: 650px;margin: auto;margin-top: 50px;">
					<div>
						<span class="t1">付款狀態：</span>
						<label><input type="checkbox" name="payment" value="未付款" style="margin-left: 20px;">未付款</label>
						<label><input type="checkbox" name="payment" value="已付款" style="margin-left: 20px;">已付款</label>
						
					</div>
					<div>
						<span class="t1">出貨狀態：</span>
						<label><input type="checkbox" name="shipment" value="未出貨" style="margin-left: 20px;">未出貨</label>
						<label><input type="checkbox" name="shipment" value="運送中" style="margin-left: 20px;">運送中</label>
						<label><input type="checkbox" name="shipment" value="已出貨" style="margin-left: 20px;">已出貨</label>
					</div>
					<div>
						<span class="t1">訂單狀態：</span>
						<label><input type="checkbox" name="status" value="訂單完成" style="margin-left: 20px;">訂單完成</label>
						<label><input type="checkbox" name="status" value="正在處理" style="margin-left: 20px;">正在處理</label>
						<label><input type="checkbox" name="status" value="訂單取消" style="margin-left: 20px;">訂單取消</label>
					</div>
