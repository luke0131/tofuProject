				...
				<div class="position-sticky pt-3 sidebar-sticky">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link active" style="color: black"
							aria-current="page" href="${contextRoot}/mgm/Dashboard"> <svg
                    ...
                    <polyline points="9 22 9 12 15 12 15 22"></polyline>
						...
						<li class="nav-item"><a class="nav-link active" href="${contextRoot}/mgm/customerManagement"
                    ...
                    <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
						...
						<li class="nav-item"><a class="nav-link active" href="http://localhost:8080/tofu/order/findAll"
							style="color: black"> <svg xmlns="http://www.w3.org/2000/svg"
									width="24" height="24" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2" stroke-linecap="round"
									stroke-linejoin="round"
                    ...
                    <polyline points="13 2 13 9 20 9"></polyline>
						...
						<li class="nav-item"><a class="nav-link active" href="http://localhost:8080/tofu/gift/findGifts"
							style="color: black"> <svg xmlns="http://www.w3.org/2000/svg"
									width="24" height="24" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2" stroke-linecap="round"
									stroke-linejoin="round"
...
<!--                   </svg> 留言管理 -->
<!-- 						</a></li> -->
						<li class="nav-item"><a class="nav-link active" href="${contextRoot}/mgm/MaintenanceManagement"
							style="color: black"> <svg xmlns="http://www.w3.org/2000/svg"
									width="24" height="24" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2" stroke-linecap="round"
									stroke-linejoin="round"
