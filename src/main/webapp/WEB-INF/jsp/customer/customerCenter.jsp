...
<body>
	...
	<h1 class="fw-bold text-center" style="margin-top: 20px ; color:#005AB5">
		<i class="fa fa-car" style="margin-right: 20px ; color:	#000079"></i>歡迎豆腐車業會員中心<i class="fa fa-car" style="margin-left: 20px;color:#000079"></i>
	</h1>
	<div class="d-flex">
