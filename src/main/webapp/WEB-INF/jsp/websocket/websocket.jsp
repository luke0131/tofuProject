	...
	window
			.addEventListener(
					...
					function() {
						...
						btnDisconnect = document
								.getElementById('btnDisconnect');
						chatId = document.getElementById('chatId');
						responseArea = document.getElementById('responseArea');
						promptArea = document.getElementById('promptArea');
						inputMessageArea = document
								.getElementById('inputMessageArea');

						btnSendToChatRoom2 = document
								.getElementById('sendToChatRoom2');
						...
						inputMessageArea.onkeyup = function() {
							if (event.keyCode === 13) {
								...
								console
										.log("=====================================================")
								console.log('from：' + chatId.value + "/n"
										+ 'text' + text)
							}
						}
	...
	<div align='center'>
		...
		<div>
			...
			<div>
				...
				<button id="btnDisconnect" disabled="disabled">退出聊天室</button>
			</div>
			<br />
