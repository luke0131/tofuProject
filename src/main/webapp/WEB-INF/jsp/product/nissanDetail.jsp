			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<svg class="" width="100%" height="100%"
						...
						<image href="../img/productDetail/Nissan Altima1.jpg" width="100%" height="100%"></image>
					</svg>
				...
				<div class="carousel-item">
					<svg class="bd-placeholder-img" width="100%" height="100%"
						...
						preserveAspectRatio="xMidYMid slice" focusable="false">
						<rect width="100%" height="100%" fill="" />
						<image href="../img/productDetail/Nissan Altima2.jpg" width="100%" height="100%"></image>
					</svg>
				...
				<div class="carousel-item">
					<svg class="bd-placeholder-img" width="100%" height="100%"
						...
						preserveAspectRatio="xMidYMid slice" focusable="false">
						<rect width="100%" height="100%" fill="" />
						<image href="../img/productDetail/Nissan Altima3.jpg" width="100%" height="100%"></image>
					</svg>
		...
		<div class="container marketing">
			...
			<div id="introduce" class="row featurette">
				<div class="col-md-7">
					<h2 class="fw-normal lh-2">
						外觀設計：<br/><br/>
						Nissan Altima的外觀設計充滿流線型的設計，特別是車頭部分，採用V-Motion設計語言，讓車頭看起來更加動感。車身線條流暢，配合下方黑色防護板，讓車身看起來更加有力量感。車尾方面則採用了緊湊的設計，尾燈與車身融為一體，讓整體設計更加精緻。
					</h2>
				</div>
				<div class="col-md-5">
					<svg
						...
						<image href="../img/productDetail/Nissan Altima4.jpg" width="100%" height="100%"></image>
					</svg>
			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					<h2 class="fw-normal lh-1">
						車內空間：<br/><br/>
						Nissan Altima的車內空間相對其他同級車型來說比較大，前排座椅和後排座椅均提供了足夠的頭部空間和腿部空間。此外，Nissan Altima還提供了選配的皮質座椅和加熱座椅等配置，提升了駕乘舒適性。車內儀表臺和中控臺也設計得十分實用，操作方便。
					</h2>
				</div>
				<div class="col-md-5 order-md-1">
					<svg
						...
						preserveAspectRatio="xMidYMid slice" focusable="false">
						<rect width="100%" height="100%" fill="white" />
						<image href="../img/productDetail/Nissan Altima5.jpg" width="100%" height="100%"></image>
					</svg>
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="fw-normal lh-1">
						動力性能：<br/><br/>
						Nissan Altima提供了兩種引擎供消費者選擇。2.5升四缸引擎可輸出188匹馬力，讓車輛的動力表現足夠強勁。另外，2.0升渦輪增壓引擎可輸出248匹馬力，進一步提升車輛的性能表現。此外，Nissan Altima還提供了可選擇的四輪驅動系統，更加增加了車輛的靈活性和行駛安全性。
					</h2>
				</div>
				<div class="col-md-5">
					<svg
						...
						preserveAspectRatio="xMidYMid slice" focusable="false">
						<rect width="100%" height="100%" fill="white" />
						<image href="../img/productDetail/Nissan Altima6.jpg" width="100%" height="100%"></image>
					</svg>
			...
			<div class="row featurette">
				...
				<form id="book" method="POST" action="${contextRoot}/product/book">
					...
					<div class="mb-3">
		  				...
		  				<input type="text" class="form-control" id="car" name="car" value="Nissan Altima">
					</div>								
